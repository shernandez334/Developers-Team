...
public class GenerateElementIdMySql {
    private static final GenerateElementQueryMySql query = new GenerateElementQueryMySql();
    private static final GetElementIdMySql getId = new GetElementIdMySql();
